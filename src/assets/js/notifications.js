        ...
        $('.show-notification').click(function(e) {
            ...
            if (style == 'Notification Bar') {
                ...
                $('body').pgNotification({
                    ...
                    timeout: 0,
                    type: type,
                    thumbnail: '<img_ width="40" height="40" style="display: inline-block;" src="assets/img_/profiles/avatar2x.jpg" data-src="assets/img_/profiles/avatar.jpg" data-src-retina="assets/img_/profiles/avatar2x.jpg" alt="">'
                }).show();
