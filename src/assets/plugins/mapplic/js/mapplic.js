	...
	var Mapplic = function() {
		...
		function Tooltip() {
			...
			this.init = function() {
				...
				this.image = $('<img_>').addClass('mapplic-tooltip-image').hide().appendTo(this.el);
		...
		function Minimap() {
			...
			this.addLayer = function(data) {
				...
				$('<img_>').attr('src', data.minimap).addClass('mapplic-minimap-background').appendTo(layer);
				$('<div></div>').addClass('mapplic-minimap-overlay').appendTo(layer);
				$('<img_>').attr('src', data.minimap).addClass('mapplic-minimap-active').appendTo(layer);
			}
		...
		function Sidebar() {
			...
			this.addCategories = function(categories) {
				...
				$.each(categories, function(index, category) {
					...
					if (category.icon) $('<img_>').attr('src', category.icon).addClass('mapplic-list-thumbnail').prependTo(link);
			...
			this.addLocation = function(data) {
				...
				if (data.thumbnail) $('<img_>').attr('src', data.thumbnail).addClass('mapplic-list-thumbnail').appendTo(link);
				...
				$.each(data.levels, function(index, value) {
					...
					switch (extension) {
						...
						case 'jpg': case 'jpeg': case 'png': case 'gif':
							$('<img_>').attr('src', source).addClass('mapplic-map-image').appendTo(layer);
							break;
