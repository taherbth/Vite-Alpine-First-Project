...
Hammer.defaults = {
  ...
  //
  // more settings are defined per gesture at gestures.js_
  //
};
...
Hammer.Instance.prototype = {
  ...
  /**
   * enable of disable hammer.js_ detection
   * @param   {Boolean}   state
   * @returns {Hammer.Instance}
   */
...
var Event = Hammer.event = {
  ...
  /**
   * collect event data for Hammer js_
   * @param   {HTMLElement}   element
   * @param   {String}        eventType        like EVENT_MOVE
   * @param   {Object}        eventData
   */
...
var Detection = Hammer.detection = {
   ...
   * @param   {Object}    gesture object, see gestures.js_ for documentation
